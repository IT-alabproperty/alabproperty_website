...
const nextConfig = {
  ...
  // Browsers request /favicon.ico by default regardless of <link rel="icon">.
  // We don't ship a binary favicon — the icon is generated by app/icon.tsx
  // at /icon. Rewrite both common default paths to that route so the browser
  // request resolves to a 200 instead of polluting Vercel logs with 404s.
  async rewrites() {
    return [
